...
<div class="form-field">
	...
	<div style="line-height:60px;">
		...
		<button id="product_brand_thumbnail_upload" type="button" class="upload_image_button button"><?php _e( 'Upload/Add image', 'yith-wcbr' ); ?></button>
		<button id="product_brand_thumbnail_remove" type="button" class="remove_image_button button"><?php _e( 'Remove image', 'yith-wcbr' ); ?></button>
	</div>
	<div class="clear"></div>
</div>